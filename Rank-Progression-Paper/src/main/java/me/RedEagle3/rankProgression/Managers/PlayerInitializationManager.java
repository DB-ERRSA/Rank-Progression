...
public class PlayerInitializationManager {
    ...
    public PlayerInitializationManager(
            JavaPlugin plugin,
    ...
    public void initializePlayer(Player player, long totalPlaytime) {

        int rankIndex = rankManager.getRankIndexForPlaytime(totalPlaytime);
    ...
    public void handleReturningPlayer(Player player) {
